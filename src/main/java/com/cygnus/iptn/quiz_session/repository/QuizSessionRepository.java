...
public interface QuizSessionRepository extends JpaRepository<QuizSession, Long> {
    ...
    where s.account.id = :accountId
      ...
      and s.sessionStatus = com.cygnus.iptn.quiz_session.entity.enums.SessionStatus.SUBMITTED
    ...
    @Query("""
        select function('date', coalesce(s.submittedAt, s.startedAt)) as d,
               ...
               sum(case when (s.parentSession is not null
                              or s.sessionMode = com.cygnus.iptn.quiz_session.entity.enums.SessionMode.WRONG_ONLY)
    ...
    @Query("""
        update QuizSession s
           set s.sessionStatus = com.cygnus.iptn.quiz_session.entity.enums.SessionStatus.EXPIRED
         where s.account.id = :accountId
           and s.deletedAt is null
           and s.dailyYmd = :dailyYmd
           and s.dailyIssueType = :issueType
           and s.dailyQuestionType = :questionType
           and s.sessionStatus = com.cygnus.iptn.quiz_session.entity.enums.SessionStatus.IN_PROGRESS
    """)
    ...
    update QuizSession s
       set s.sessionStatus = com.cygnus.iptn.quiz_session.entity.enums.SessionStatus.EXPIRED
     where s.sessionStatus = com.cygnus.iptn.quiz_session.entity.enums.SessionStatus.IN_PROGRESS
