...
public class QuestionTypeScope {
    ...
    public QuestionType toEntityOrNull() {
        ...
        return switch (type) {
            case CHOICE -> com.cygnus.iptn.quiz_question.entity.enums.QuestionType.CHOICE;
            case OX -> com.cygnus.iptn.quiz_question.entity.enums.QuestionType.OX;
            case INITIALS -> com.cygnus.iptn.quiz_question.entity.enums.QuestionType.INITIALS;
            default -> null;
        };
    }
}
