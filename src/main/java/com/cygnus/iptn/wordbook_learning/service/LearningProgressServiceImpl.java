...
public class LearningProgressServiceImpl implements LearningProgressService {
    ...
    public UpdateLearningProgressResponse updateMemorization(UpdateLearningProgressRequest request) {
        ...
        var accRef  = em.getReference(com.cygnus.iptn.account.entity.Account.class, request.getAccountId());
        var termRef = em.getReference(com.cygnus.iptn.term.entity.Term.class, request.getTermId());
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
            ...
            public void afterCommit() {
                wordbookQueryService.evictMyFoldersStatsCache(accountId);
            }
        });
