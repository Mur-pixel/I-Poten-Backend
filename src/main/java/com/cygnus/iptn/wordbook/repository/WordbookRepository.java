package com.cygnus.iptn.wordbook.repository;
...
public interface WordbookRepository extends JpaRepository<Wordbook, Long> {
    ...
    @Query("""
        select new com.cygnus.iptn.wordbook.repository.projection.WordbookCountRow(
            wb.id,
            wb.wordbookName,
    ...
    @Query("""
        select new com.cygnus.iptn.wordbook.controller.response_form.MyWordbookListResponseForm$Item(
            wb.id,
            wb.wordbookName,
