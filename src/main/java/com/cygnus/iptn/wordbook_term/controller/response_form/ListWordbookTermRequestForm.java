package com.cygnus.iptn.wordbook_term.controller.response_form;
...
@NoArgsConstructor
@ToString
public class ListWordbookTermRequestForm {
    ...
    public ListWordbookTermRequest toListUserTermRequest(Long accountId, Long folderId) {
        return new ListWordbookTermRequest(accountId, folderId, resolvePage(), resolvePageSize(), sanitizeSort(sort));
    }
}
