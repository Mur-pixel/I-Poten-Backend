...
public class JobRecommendedTerm {
    ...
    private JobRecommendedTerm(JobKey jobKey, Term term, int rankNo) {
    ...
    public static JobRecommendedTerm create(JobKey jobKey, Term term, int rankNo) {
        return new JobRecommendedTerm(jobKey, term, rankNo);
    }
