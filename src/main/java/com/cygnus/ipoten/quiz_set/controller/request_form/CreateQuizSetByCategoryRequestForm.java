package com.cygnus.ipoten.quiz_set.controller.request_form;
...
public class CreateQuizSetByCategoryRequestForm {
    ...
    private DifficultyLevel parseDifficultyLevel(String s) {
        String key = (s == null || s.isBlank()) ? "MEDIUM" : s.trim().toUpperCase();
        try {
            return DifficultyLevel.valueOf(key);
