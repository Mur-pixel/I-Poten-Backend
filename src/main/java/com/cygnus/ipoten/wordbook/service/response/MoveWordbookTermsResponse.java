...
@Getter
@AllArgsConstructor
public class MoveWordbookTermsResponse {
    ...
    /** 소스와 타겟이 같은 경우 */
    public static MoveWordbookTermsResponse sameFolder(Long folderId, List<Long> termIds) {
        List<Skipped> skipped = new ArrayList<>();
        for (Long termId : termIds) {
            skipped.add(new Skipped(termId, Skipped.Reason.SAME_WORDBOOK));
        }
        return new MoveWordbookTermsResponse(folderId, folderId, 0, skipped, List.of());
    }
}