package com.cygnus.ipoten.custom_term_learning.controller;

import com.cygnus.ipoten.custom_term_learning.service.LearningProgressService;
import com.cygnus.ipoten.custom_term_learning.controller.request_form.UpdateLearningProgressRequestForm;
import com.cygnus.ipoten.custom_term_learning.controller.response_form.UpdateLearningProgressResponseForm;
...
public class LearningProgressController {
    ...
    public ResponseEntity<?> getMyFoldersWithStats(
        ...
        try {
            ...
            if (page == null) {
                var list = wordbookFolderQueryService.getMyFoldersWithStats(accountId);
            ...
            var paged = wordbookFolderQueryService.getMyFoldersWithStatsPaged(accountId, p, s, sort, q);
