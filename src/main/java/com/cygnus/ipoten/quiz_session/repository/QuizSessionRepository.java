...
public interface QuizSessionRepository extends JpaRepository<QuizSession, Long> {
    ...
    Optional<QuizSession> findTopByAccount_IdAndDailyYmdAndDailyIssueTypeAndDailyQuestionTypeAndSessionStatusInOrderByStartedAtDesc(
            Long accountId,
            LocalDate dailyYmd,
    ...
    Optional<QuizSession> findTopByAccount_IdAndDailyIssueTypeAndSessionStatusInOrderByStartedAtDesc(
            Long accountId,
            String dailyIssueType,
