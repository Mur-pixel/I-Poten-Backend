package com.cygnus.ipoten.batch.recommendation;
...
public class JobRecommendedTermTsvImportRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        for (var entry : grouped.entrySet()) {
            ...
            var jobKey = com.cygnus.ipoten.recommendation.entity.enums.JobKey.valueOf(jobKeyStr.toUpperCase(Locale.ROOT));
